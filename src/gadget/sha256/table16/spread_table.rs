...
pub fn interleave_u16_with_zeros(input: u16) -> u32 {
    let mut word: u32 = input.into();
...
mod tests {
    ...
    use super::{
        super::{MessageScheduler, Table16Chip, Table16Config},
            ...
            fn synthesize(
                ...
                layouter.assign_region(|mut gate| {
                    ...
                    for _ in 0..10 {
                        ...
                        add_row(
                            F::from_u64(super::get_tag(word).into()),
                            F::from_u64(word.into()),
                            F::from_u64(super::interleave_u16_with_zeros(word).into()),
                        )?;
                    }
